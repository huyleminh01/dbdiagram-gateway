const dynamicProxyPolicy = require('./policies/dynamic-proxy');
const dynamicWsProxyPolicy = require('./policies/dynamic-ws-proxy');

module.exports = {
  version: '0.0.1',
  schema: {
    $id: 'http://express-gateway.io/schemas/policies/custom-proxies.json',
    type: 'object',
    properties: {
      auth: {
        type: 'string',
  ...
  init: function (pluginContext) {
    pluginContext.registerPolicy(dynamicProxyPolicy);
    pluginContext.registerPolicy(dynamicWsProxyPolicy);
  },
  policies: ['dynamic-proxy', 'dynamic-ws-proxy'],
};
